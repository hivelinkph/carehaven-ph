...
export function FacilityForm({ facility, mode, isAdmin }: FacilityFormProps) {
    ...
    const handleCityChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
        ...
        const loc = locations.find(l => l.name === selectedCity);
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6" style={{ fontFamily: "var(--font-ui)" }}>
                ...
                <div className="space-y-2">
                    ...
                    <select
                        ...
                        className="w-full px-4 py-2 border border-[#e8e6dc] rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2DD1AC]/50 bg-white"
                    >
                        <option value="" disabled>Select a valid city</option>
                        {locations.map(loc => (
                ...
                <div className="space-y-2">
                    ...
                    <input
                        ...
                        className="w-full px-4 py-2 border border-[#e8e6dc] rounded-xl bg-[#faf9f5] text-gray-500 cursor-not-allowed"
                    />
                </div>
